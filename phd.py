    ...
    async with event.client.conversation("@phsavebot") as conv:
          ...
          try:
              ...
              if "language" in oop.text:
                  ...
                  await bot.send_message(event.chat_id, "**Please go to** @phsavebot **and select your language**")
              ...
              try:
                  ...
                  await bot(JoinChannelRequest('Allsavernews'))
              ...
              if "Downloading" in response.text:
                  ...
                  await bot.send_file(event.chat_id, video_hehe, caption="`🤤 Video Uploaded by` [@anubisxx](https://github.com/Dark-Princ3/X-tra-Telegram)!🤤\n**Title:** `{}`".format(title))
