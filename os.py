...
@bot.on(admin_cmd(pattern=r"macos"))
...
@bot.on(admin_cmd(pattern=r"windows"))
...
@bot.on(admin_cmd(pattern=r"linux"))
...
@bot.on(admin_cmd(pattern=r"stock"))
...
async def _(event):
    ...
    animation_chars = [
            ...
            "__Current Loaded OS: Symbian OS__\n\n**To Boot Other OS, Use The Following Trigger:**\n✅ `.macos`\n✅ `.windows`\n☑️ `.linux`\n☑️ `.stock`",
            "__Current Loaded OS: Symbian OS__\n\n**To Boot Other OS, Use The Following Trigger:**\n✅ `.macos`\n✅ `.windows`\n✅ `.linux`\n☑️ `.stock`",
            "__Current Loaded OS: Symbian OS__\n\n**To Boot Other OS, Use The Following Trigger:**\n✅ `.macos`\n✅ `.windows`\n✅ `.linux`\n✅ `.stock`\n\nDeveloped By: @Dark_cobra_support"
 ]
