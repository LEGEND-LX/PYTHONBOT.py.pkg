...
from userbot.cmdhelp import CmdHelp,YOUTUBE_API_KEY
...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("Click [here](https://github.com/kaal0408/darkultra) to open this cool userbot repo 𝔻𝔸ℝ𝕂 ultra.")
